...
<head>
  ...
  <link href="css/style.css" rel="stylesheet"> <!--this!-->
...
<button class="button one"><a href="sign_up.php"> Sign Up</a> </button>
<button class="button tow"> <a href="login.php"> sign in</a> </button>
<!--
<div class="btm">
<button class="button one">Join us</button>
</div>
<div class="btm2">
<button class="button two">Log in</button>
</div>
!-->
